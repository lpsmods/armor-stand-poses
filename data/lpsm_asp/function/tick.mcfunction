...
# Armor Stand init
execute as @e[type=armor_stand, tag=!init, tag=!global.ignore, nbt={Invisible:0b, OnGround:1b}] at @s run function lpsm_asp:armor_stand/init

# Armor Stand tick
execute as @e[type=armor_stand, tag=init] at @s run function lpsm_asp:armor_stand/tick
