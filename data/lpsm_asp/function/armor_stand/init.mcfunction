...
# Inital scores
scoreboard players set @s lpsm_asp.power 0
scoreboard players set @s lpsm_asp.lastPower 0

# Apply default pose
function lpsm_asp:api/from_id {id: "default"}
